...
from . inference import output_sequence_meshes
from .. smpl_webuser.serialization import load_model

# def edit_sequences(mode, param_a, param_b, source_path, out_path, flame_model_path, uv_template_fname='', texture_img_fname=''):
#     if mode == 'Blink':
...
#     elif mode == 'Shape':
#         alter_sequence_shape(source_path, out_path, flame_model_path, pc_idx=param_a, pc_range=param_b, uv_template_fname='', texture_img_fname='')
#     elif mode == 'Pose':
#         alter_sequence_head_pose(source_path, out_path, flame_model_path, pose_idx=param_a, rot_angle=param_b, uv_template_fname='', texture_img_fname='')
