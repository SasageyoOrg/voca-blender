...
# BACKUP: versione FUNZIONANTE con due operatori: (import mesh e load model)
...
class MeshImportOperator(bpy.types.Operator):
    """VOCA Inference"""      # Use this as a tooltip for menu items and buttons.
    bl_idname = "opr.mashimport"        # Unique identifier for buttons and menu items to reference.
...
def menu_func(self, context):
    self.layout.operator(RunVOCAOperator.bl_idname)
'''
